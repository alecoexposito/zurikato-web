    ...
    controller: ['Device', '$http', '$timeout', 'NgMap', '$routeParams', '$localStorage',
        function DeviceAlarmController(Device, $http, $timeout, NgMap, $routeParams, $localStorage) {
            ...
            self.alertC5 = function alertC5(e) {
                ...
                var secondsDiff = parseInt((milisecondsNow - milisecondsMidnight) / 1000);
                var speed = d.peripheral_gps_data[0].speed;
                var economic_number = d.vehicle != null ? d.vehicle.plate_number : null;
